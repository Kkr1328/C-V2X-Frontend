...
export default function CarCard(props: CarCardProps) {
	...
	return isFocus ? (
		<Card
			...
			className="bg-light_background_grey border-2 border-primary_blue cursor-zoom-out rounded-lg my-16 p-8"
		>
			<InCard
				id={car.id}
				name={car.name}
		...
		<Card
			onClick={props.onClick}
			className="bg-light_background_grey cursor-zoom-in rounded-lg my-16 p-8"
		>
			<InCard
				id={car.id}
				name={car.name}
