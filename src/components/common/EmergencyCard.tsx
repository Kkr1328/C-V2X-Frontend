			...
			{(provided) => {
				return (
					<Card
						...
						className={`w-280 h-[83px] min-h-[83px] rounded-l-none rounded-r-lg border-l-8 p-16 mt-16 bg-dark_background_grey hover:bg-light_background_grey ${props.state === 'PENDING'
							? 'border-error_red'
