...
export default function VideoReceiver(props: VideoReceiverProps) {
    ...
    useEffect(() => {
        if (!connection.current) {
          ...
          connection.current.videosContainer = document.getElementById("videos-container") ?? document.body;
          showCam();
      ...
      const showCam = () => {
        ...
        connection.current?.join(`Room${props.carID}${props.camNumber}`, function () {
